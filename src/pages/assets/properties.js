...
// Because the code moved into the zts-command-center monorepo, the retired
// per-app repos are gone too: the `repo` pointers below follow the code to the
// monorepo (auto-fix probes apps/shell/ there — see REPO_DIRS in
// netlify/functions/auto-fix.js), and Macro's `site` slug follows the deploy
// target to the-pentagon. Pointing either at a deleted repo/site 404s.
export const PROPERTIES = [
  ...
  { name: "Clarify Paid Search", desc: "Boutique Google Ads agency", url: "https://clarifypaidsearch.com", appUrl: "https://the-pentagon.netlify.app", color: "var(--amber)", repo: "camcarp14/zts-command-center", site: "clarify-paid-search" },
  ...
  { name: "Macro Command Center", desc: "Markets, portfolio, thesis", url: null, appUrl: "https://the-pentagon.netlify.app", color: "var(--blue)", repo: "camcarp14/zts-command-center", site: "the-pentagon" },
